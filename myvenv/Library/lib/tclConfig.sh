...
# installed.
TCL_PREFIX='E:/waste-classifier/VS CODE/myvenv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='E:/waste-classifier/VS CODE/myvenv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='E:/waste-classifier/VS CODE/myvenv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IE:/waste-classifier/VS CODE/myvenv\Library\include'
...
TCL_PACKAGE_PATH='E:/waste-classifier/VS CODE/myvenv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LE:/waste-classifier/VS CODE/myvenv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='E:/waste-classifier/VS CODE/myvenv\Library\lib\tclstub86.lib'
